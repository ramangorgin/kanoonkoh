...
<section class="py-5 bg-white">
    <div class="container">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="{{ route('programs.archive') }}" class="btn btn-outline-primary btn-sm">مشاهده همه</a>
        </div>
...
<section class="py-5 bg-light">
    <div class="container">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="{{ route('courses.archive') }}" class="btn btn-outline-primary btn-sm">مشاهده همه</a>
        </div>
