        ...
        <tbody>
            @foreach($programs as $program)
                <tr>
                    ...
                    <td>
                        <a href="{{ route('admin.registrations.show', ['type' => 'program', 'id' => $program->id]) }}" class="btn btn-sm btn-warning">ثبت‌نامی‌ها</a>
                        <a href="{{ route('admin.programs.show', $program->id) }}" class="btn btn-sm btn-info">مشاهده</a>
